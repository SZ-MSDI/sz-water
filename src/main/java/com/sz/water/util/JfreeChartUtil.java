...
public class JfreeChartUtil {
	...
	public static JFreeChart createLineChart(String title, String domainAxisName, String rangeAxisName,
			DefaultCategoryDataset ds) {
		JFreeChart chart = ChartFactory.createLineChart3D(title, domainAxisName, rangeAxisName, ds,
	...
	public static JFreeChart createCategoryDataset(String title, String domainName, String rangeName,
			DefaultCategoryDataset dataset, String path) {
		JFreeChart chart = ChartFactory.createBarChart(title, domainName, rangeName, dataset, PlotOrientation.VERTICAL,
				true, true, false);
		chart.getTitle().setFont((new Font("隶书", Font.CENTER_BASELINE, 20))); // 设置标题字体
	...
	public static JFreeChart createBarChart(String title, String domainName, String rangeName,
			CategoryDataset dataset) {
		JFreeChart chart = ChartFactory.createBarChart3D(title, domainName, rangeName, dataset,
	...
	public static JFreeChart createPointChart(XYDataset xydataset, String title, String domainName, String rangeName,
			String noDateMsg) {
	 ...
	 * 饼状图数据类型
	 */
	public static DefaultPieDataset getPieData(String[] keys, double[] data) {
	 ...
	 * 折线条类型
	 */
	public static DefaultCategoryDataset getLineData(String[] rowKey, double[][] data, String[][] columnKey) {
		DefaultCategoryDataset dataset = new DefaultCategoryDataset();
		for (int i = 0; i < rowKey.length; i++) {
			for (int j = 0; j < columnKey.length; j++) {
				dataset.addValue(data[i][j], rowKey[i], columnKey[i][j]);
			}
		}
		return dataset;
	}
	 ...
	 * 柱状类型
	 */
	public static DefaultCategoryDataset getBarData(String[] rowKey, double[][] data, String[] columnKey) {
		DefaultCategoryDataset dataset = new DefaultCategoryDataset();
		for (int i = 0; i < rowKey.length; i++) {
			for (int j = 0; j < columnKey.length; j++) {
				dataset.addValue(data[i][j], rowKey[i], columnKey[j]);
			}
		}
	 ...
	 * 散点图
	 */
	public static CategoryDataset getPointData(String[] rowKey, double[][] data, String[] columnKe) {

		return DatasetUtilities.createCategoryDataset(rowKey, columnKe, data);
	}
}
